...
try:
    ...
    browser.find_element_by_xpath('//*[@id="login"]/form/div[4]/input[9]').click()  # click sign in
    ...
    print('[ERROR]: couldn\'t setup gitgub repo')
else:
    github = True
...
# initialize git in the project directory
    ...
    os.system('git init')
    if github:
        os.system(f'git remote add origin https://github.com/Hank2q/{project_name}.git')
    os.system('git add .')
